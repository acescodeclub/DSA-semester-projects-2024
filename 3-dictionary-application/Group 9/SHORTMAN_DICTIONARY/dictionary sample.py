...
def searchWordFromDictionary(word):
    print(dictionary.get(word, None))
...
class MainScreen(Screen):
    ...
    def search_word(self, instance):
        ...
        result = searchWordFromDictionary(word)
        ...
        if result:
            ...
            self.manager.get_screen('meaning_screen').display_meaning(word, result["meaning"],result["synonym"], result.get("image", None))
...
class MeaningScreen(Screen):
    def __init__(self, **kwargs):
        ...
        self.synonym_label = Label(text='', color=(0, 0, 0, 1), font_size='18sp', size_hint=(None, None), size=(100, 100), pos_hint={'center_x': 0.5, 'center_y': 1.3}, text_size=(300, None), halign='center', valign='middle')
